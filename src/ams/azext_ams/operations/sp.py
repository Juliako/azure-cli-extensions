...
from azext_ams._client_factory import (_graph_client_factory, _auth_client_factory)
from azext_ams._utils import (_gen_guid, _is_guid)
...
def create_assign_sp_to_mediaservice(cmd, client, account_name, resource_group_name, sp_name=None,
    ...
    format_xml_fn = getattr(importlib.import_module('azext_ams._format'),
