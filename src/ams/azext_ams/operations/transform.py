...
def create_transform(client, account_name, resource_group_name, transform_name, preset_name, location=None, description=None, tags=None):
    from azext_ams.mediav3.models import (Transform, TransformOutput, BuiltInStandardEncoderPreset)
    ...
    transform_parameters = Transform(outputs=[transform_output], location=location, description=description, tags=tags)
...
def add_transform_output(cmd, client, account_name, resource_group_name, transform_name, preset_name):
    from azext_ams.mediav3.models import (TransformOutput, BuiltInStandardEncoderPreset)
